 ...
 * 1. Setup Arduino with Sanguino board:
 ...
 *      - Tools > Manage Libraries > Search for "u8glib". version 1.19.1 at the time of writing. > Install.
 * 2. Choose correct board settings:
